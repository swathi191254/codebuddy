  ...
  return (
    ...
    <Main>
      <DropDownContainer>
        ...
        <DropDownHeader  ><img onClick={toggling} className="drop-menu" src="https://w7.pngwing.com/pngs/639/1013/png-transparent-hamburger-button-computer-icons-drop-down-list-fast-food-menu-rectangle-share-icon-pancake-thumbnail.png" alt="" />
</DropDownHeader>
        {isOpen && (
